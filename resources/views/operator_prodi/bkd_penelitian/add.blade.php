    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-user-circle"></i>&nbsp;Tambah Data Bkd Bidang Penelitian dan Pengembangan Ilmu Dosen {{ $dosen->nama_lengkap }}</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('operator_prodi.bkd_penelitian.post') }}" method="POST" >
