    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-user-circle"></i>&nbsp;Edit Data Bkd Penelitian dan Pengembangan Ilmu Dosen {{ $dosen->nama_lengkap }}</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('operator_prodi.bkd_penelitian.update',[$data->id]) }}" method="POST" >
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1">Jenis Kegiatan</label>
                                <textarea name="jenis_kegiatan" class="form-control" id="" cols="30" rows="3">{{ $data->jenis_kegiatan }}</textarea>
                                <div>
                            ...
                            <div class="col-md-12 text-center">
                                <a href="{{ route('operator_prodi.bkd_penelitian') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
