    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-user"></i>&nbsp;Manajemen Data Bkd Bidang Penelitian dan Pengembangan Ilmu</h3>
                <div class="pull-right">
                    <a href="{{ route('operator_prodi.bkd_penelitian.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Bkd Penelitian</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <form action="{{ route('operator_prodi.bkd_penelitian.pilih_dosen') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td>
                                                    <a href="{{ route('operator_prodi.bkd_penelitian.edit',[$data->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('operator_prodi.bkd_penelitian.delete',[$data->id]) }}" method="POST">
