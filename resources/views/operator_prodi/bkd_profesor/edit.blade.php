    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-user-circle"></i>&nbsp;Edit Data Bkd Kewajiban Khusus Profesor Dosen {{ $dosen->nama_lengkap }}</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('operator_prodi.bkd_profesor.update',[$data->id]) }}" method="POST" >
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                            ...
                            <div class="col-md-12 text-center">
                                <a href="{{ route('operator_prodi.bkd_profesor') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
