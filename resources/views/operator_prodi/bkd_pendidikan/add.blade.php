    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-user-circle"></i>&nbsp;Tambah Data Bkd Pendidikan Dosen {{ $dosen->nama_lengkap }}</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('operator_prodi.bkd_pendidikan.post') }}" method="POST" >
                        {{ csrf_field() }} {{ method_field('POST') }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="jtm" class="form-control" >
                                <div>
                                    @if ($errors->has('jtm'))
