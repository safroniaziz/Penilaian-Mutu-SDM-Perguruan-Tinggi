    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-user"></i>&nbsp;Manajemen Data Bkd Bidang Pendidikan</h3>
                <div class="pull-right">
                    <a href="{{ route('operator_prodi.bkd_pendidikan.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Bkd Pendidikan</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <form action="{{ route('operator_prodi.bkd_pendidikan.pilih_dosen') }}">
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td>
                                        {{ $data->jenis_kegiatan }}
                                        <br>
                                        <small class="label label-success">JM : {{ $data->jm }}</small>
                                        <small class="label label-primary">JP : {{ $data->jp }}</small>
                                        <small class="label label-danger">JTM : {{ $data->jtm }}</small>
                                        <small class="label label-warning">{{ $data->dosen->nama_lengkap }}</small>
                                    </td>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td>
                                                    <a href="{{ route('operator_prodi.bkd_pendidikan.edit',[$data->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('operator_prodi.bkd_pendidikan.delete',[$data->id]) }}" method="POST">
