        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <a href="{{ route('operator_prodi.bkd_tridharma.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Bkd Tridharma</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <form action="{{ route('operator_prodi.bkd_tridharma.pilih_dosen') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td>
                                                    <a href="{{ route('operator_prodi.bkd_tridharma.edit',[$data->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('operator_prodi.bkd_tridharma.delete',[$data->id]) }}" method="POST">
