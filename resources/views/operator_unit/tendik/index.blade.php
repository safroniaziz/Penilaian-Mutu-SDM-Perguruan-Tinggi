                                ...
                                <tr>
                                    ...
                                    <td style="display:inline-block !important;">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a href="{{ route('operator_unit.tendik.edit',[$tendik->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('operator_unit.tendik.delete',[$tendik->id]) }}" method="POST">
