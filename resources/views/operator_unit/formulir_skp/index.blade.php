        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <a href="{{ route('operator_unit.formulir.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Sasaran Kerja</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <form action="{{ route('operator_unit.formulir.pilih_tendik') }}">
                            <div class="form-group col-md-12">
                                <label for="my-input">Pilih Tendik Terlebih Dahulu</label>
                                <select name="tendik_id" class="form-control select2" id="">
                                    <option disabled selected>-- pilih tendik --</option>
                                    @foreach ($tendiks as $tendik)
                                        <option value="{{ $tendik->id }}"
                                            @if ($tendik->id == session('tendik'))
                                                selected
                                            @endif
                                        >{{ $tendik->nama_lengkap }}</option>
                                    @endforeach
                                </select>
                                <div>
                                    @if ($errors->has('tendik_id'))
                                        <small class="form-text text-danger">{{ $errors->first('tendik_id') }}</small>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-check-circle"></i>&nbsp; Pilih tendik</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-md-12 table-responsive" style="margin-top:10px !important">
                    <table class="table table-striped table-bordered" id="table" style="width:100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>1</td>
                                <td>Mengarsipkan Surat mask dan keluar segala jurusan
                                    <br>
                                    <small class="label label-success">Safroni Aziz Suprianto</small>
                                </td>
                                <td>SK</td>
                                <td>2</td>
                                <td>Semester Ganjil 2022</td>
                                <td>SK</td>
                                <td>100</td>
                                <td>2</td>
                                <td>
                            ...
                            <tr>
                                <td>2</td>
                                <td>Laporan Monitoring Ternak<br>
                                    <small class="label label-success">Safroni Aziz Suprianto</small></td>
                                <td>SK</td>
                                <td>2</td>
                                <td>Semester Ganjil 2022</td>
                                <td>SK</td>
                            ...
                            <tr>
                                <td>3</td>
                                <td>Menyiapkan Praktikum Mahasiswa<br>
                                    <small class="label label-success">Safroni Aziz Suprianto</small></td>
                                <td>SK</td>
                                <td>2</td>
                                <td>Semester Ganjil 2022</td>
                            ...
                            <tr>
                                <td>4</td>
                                <td>Laporan Pelaksanaan tugas lain yang diberikan atasan<br>
                                    <small class="label label-success">Safroni Aziz Suprianto</small></td>
                                <td>SK</td>
                                <td>2</td>
                                <td>Semester Ganjil 2022</td>
                            ...
                            <tr>
                                <td>5</td>
                                <td>Melaporkan pelaksanaan tugas kepada atasan sebagai pertaggung jawaban pelaksanaan tugas<br>
                                    <small class="label label-success">Safroni Aziz Suprianto</small></td>
                                <td>SK</td>
                                <td>2</td>
                                <td>Semester Ganjil 2022</td>
