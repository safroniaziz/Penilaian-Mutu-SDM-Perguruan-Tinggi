        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('operator_unit.dosen.update',[$data->id]) }}" method="POST" >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="prodi_id" id="prodi_id" class="form-control">
                                ...
                                @foreach ($prodis as $item)
                                    <option value="{{ $item->id }}" @if ($item->id == $data->prodi_id)
                                        selected
                                    @endif>{{ $item->nama_prodi }}</option>
                                @endforeach
                            </select>
                            <div>
                                <small style="display: none;" class="form-text text-danger" id="tidak_ditemukan">Program Studi tidak ditemukan</small>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-12 text-center">
                                <a href="{{ route('operator_unit.dosen') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
