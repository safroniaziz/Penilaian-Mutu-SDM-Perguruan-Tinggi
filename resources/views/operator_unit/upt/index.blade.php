    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-clone"></i>&nbsp;Manajemen Data Unit Pelayanan Terpadu</h3>
                <div class="pull-right">
                    <a href="{{ route('operator_unit.upt.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data UPT</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                                    ...
                                    <td> {{ $unit->nama_unit }} </td>
                                          <td style="display:inline-block !important;">
                                            <table>
                                                <tr>
                                                    <td>
                                                       <a href="{{ route('operator_unit.upt.edit',[$unit->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>


                                                    </td>
                                                    <td>

                                                       <form action="{{ route('operator_unit.upt.delete',[$unit->id]) }}" method="POST">
            ...
            {{--  <div class="modal fade modal-danger" id="modaldelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action=" {{ route('operator_unit.upt.delete',[$indikator->id]) }}" method="POST">
                            {{ csrf_field() }} {{ method_field('DELETE') }}
