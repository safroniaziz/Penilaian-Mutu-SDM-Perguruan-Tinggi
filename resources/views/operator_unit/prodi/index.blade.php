        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <a href="{{ route('operator_unit.prodi.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Program Studi</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                                        ...
                                        @endif
                                          ...
                                          <td style="display:inline-block !important;">
                                            <table>
                                                <tr>
                                                    <td>
                                                       <a href="{{ route('operator_unit.prodi.edit',[$prodis->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                                    </td>
                                                    <td>
                                                       <form action="{{ route('operator_unit.prodi.delete',[$prodis->id]) }}" method="POST">
            ...
            {{--  <div class="modal fade modal-danger" id="modaldelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action=" {{ route('operator_unit.prodi.delete',[$indikator->id]) }}" method="POST">
                            {{ csrf_field() }} {{ method_field('DELETE') }}
