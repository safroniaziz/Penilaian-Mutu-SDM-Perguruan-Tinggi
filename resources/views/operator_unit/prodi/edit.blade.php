        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('operator_unit.prodi.update',[$data->id]) }}" method="POST" >
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Masukan Nama Prodi</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="fakultas_id" class="form-control" id="">
                                    @foreach ($fakultas as $fakultas)
                                        <option value="{{ $fakultas->id }}" @if ($data->fakultas_id == $fakultas->id)
                                            selected
                                        @endif>{{ $fakultas->nama_unit }}</option>
                                    @endforeach
                                </select>
                                <div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    @if ($errors->has('jumlah_mahasiswa'))
                                        <small class="form-text text-danger">{{ $errors->first('jumlah_mahasiswa') }}</small>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="jumlah_dosen" class="form-control" value="{{ $data->jumlah_dosen }}">
                                <div>
                                    @if ($errors->has('jumlah_dosen'))
                                        <small class="form-text text-danger">{{ $errors->first('jumlah_dosen') }}</small>
                                    @endif
                                </div>
                            </div>

                            <div class="col-md-12 text-center">
                                <a href="{{ route('operator_unit.prodi') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
