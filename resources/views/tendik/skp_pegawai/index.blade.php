...
@section('content')
<div class="row">
    @if (Auth::guard('tendik')->user()->skp()->count() >0)
        <div class="col-md-12">
            <div class="row">
                @include('tendik/skp_pegawai.pejabat_dinilai')
                @include('tendik/skp_pegawai.pejabat_penilai')
                @include('tendik/skp_pegawai.atasan_pejabat_penilai')
            </div>
        </div>
        <div class="col-md-12">
            <div class="row">
                @include('tendik/skp_pegawai.list_skp_detail')
            </div>
        </div>
    @else
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-list"></i>&nbsp;Data SKP Tendik </h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="modal fade" id="modal-default">
                            <form action="{{ route('tendik.skp.post',[Auth::guard('tendik')->user()->id]) }}" method="POST">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Formulir Tambah Data SKP Tendik</h4>
                                        </div>
