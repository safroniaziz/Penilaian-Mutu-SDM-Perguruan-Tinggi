        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="col-md-12 table-responsive">
                    @if (Auth::user()->reviewerBanPtTendik()->get()->count() < 1)
                        <div class="alert alert-danger">Mohon Maaf, Anda Bukan Reviewer Tendik Berdasarkan Indikator BAN-PT</div>
                    @else
                        <table class="table table-striped table-hover" id="table" style="width:100%;">
                            <form action="{{ route('reviewer.penilaian_banpt_tendik.post') }}" method="POST">
