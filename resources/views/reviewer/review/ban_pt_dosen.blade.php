        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="col-md-12 table-responsive">
                    @if (Auth::user()->reviewerBanPtDosen()->get()->count() < 1)
                        <div class="alert alert-danger">Mohon Maaf, Anda Bukan Reviewer Mutu Dosen BAN-PT</div>
                    @else
                        @if (Auth::user()->hasilReviewBanPtDosen()->get()->count()>0)
                            <div class="alert alert-success">Terimakasih, Hasil Review Anda Sudah Tersimpan</div>
                        @else
                            <table class="table table-striped table-hover" id="table" style="width:100%;">
                                <form action="{{ route('reviewer.penilaian_banpt_dosen.post') }}" method="POST">
