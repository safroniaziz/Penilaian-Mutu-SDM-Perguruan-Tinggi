        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="col-md-12 table-responsive">
                    @if (Auth::user()->reviewerManajerialTendik()->get()->count() < 1)
                        <div class="alert alert-danger">Mohon Maaf, Anda Bukan Reviewer Aspek Manajerial Tendik Berdasarkan Indikator Badan Penjamin Mutu</div>
                    @else
                        <table class="table table-striped table-hover" id="table" style="width:100%;">
                            <form action="{{ route('reviewer.penilaian_manajerial.post') }}" method="POST">
