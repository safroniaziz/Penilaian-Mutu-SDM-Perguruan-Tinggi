    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-calendar-times-o"></i>&nbsp;Edit Data Kriteria Aspek Teknis</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('lpmpp.KriteriaTendikBpmAspekManajerial.update',[$data->id]) }}" enctype="multipart/form-data" method="POST">
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Masukan Kriteria Aspek Teknis</label>
