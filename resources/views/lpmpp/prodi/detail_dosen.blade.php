...
@push('styles')
    ...
    <style>
        #chartdivgolongandosen{
            width: 90%;
            height: 350px;
        }
        #chartdivjabatandosen{
            width: 90%;
            height: 250px;
        }
    </style>
...
<div class="row">
    ...
    <div class="col-md-7">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-calendar"></i>&nbsp;Data Dosen Prodi <b>{{ $prodi->nama_prodi.'-'.$prodi->unit->nama_singkatan }}</b></h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12" style="margin-bottom: 10px !important;">
                        <div class="alert alert-info">
                            <b>Perhatian</b> <br>
                            Data dosen tersinkronisasi dengan Sistem Informasi Akademik (SIAKAD) Universitas Bengkulu, data yang disinkronisasi hanyalah data dosen berstatus aktif di SIAKAD,
                        ...
                        <a href="{{ route('lpmpp.prodi.sync_dosen_detail',[$prodi->id]) }}" onclick="sinkronisasiPanda()" class="btn btn-success btn-sm btn-flat"><i class="fa fa-refresh fa-spin"></i>&nbsp; Sinkronisasi Pangkalan Data</a>
                    </div>
    ...
    @include('lpmpp/prodi.__grafik_golongan_dosen')
    @include('lpmpp/prodi.__grafik_jabatan_dosen')
</div>
@endsection
@push('scripts')
    @include('lpmpp/prodi/__pie_chart_golongan_dosen')
    @include('lpmpp/prodi/__pie_chart_jabatan_dosen')
