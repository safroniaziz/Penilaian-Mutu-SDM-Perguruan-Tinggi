    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-calendar-times-o"></i>&nbsp;Edit Data Bab Indikator Penilaian</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('lpmpp.babIndikator.update',[$data->id]) }}" enctype="multipart/form-data" method="POST">
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Masukan Bab Indikator Penilaian</label>
                            <input type="text" name="nama_bab" class="form-control" value="{{ $data->nama_bab }}">
                            <div>
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <a href="{{ route('lpmpp.babIndikator') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
