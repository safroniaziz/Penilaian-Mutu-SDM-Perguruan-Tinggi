        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <a href="{{ route('lpmpp.fakultas.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Fakultas</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                                    ...
                                    <td> {{ $unit->nama_unit }} </td>
                                          <td style="display:inline-block !important;">
                                            <table>
                                                <tr>
                                                    <td>
                                                       <a href="{{ route('lpmpp.fakultas.edit',[$unit->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>


                                                    </td>
                                                    <td>

                                                       <form action="{{ route('lpmpp.fakultas.delete',[$unit->id]) }}" method="POST">
