        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <a href="{{ route('lpmpp.tendik_ban_pt.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Indikator Penilaian</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <form action="{{ route('lpmpp.tendik_ban_pt.delete',[$indikator->id]) }}" method="POST">
