        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('lpmpp.tendik_ban_pt.post') }}" enctype="multipart/form-data" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }} {{ method_field('POST') }}
                            ...
                            <div class="col-md-12 text-center">
                                <a href="{{ route('lpmpp.tendik_ban_pt') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
