        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <a href="{{ route('lpmpp.reviewer_manajerial.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Reviewer</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td style="display:inline-block !important;">
                                        <table>
                                            <tr>
                                                <td>
                                                    <form action="{{ route('lpmpp.reviewer_manajerial.delete',[$reviewer->id]) }}" method="POST">
