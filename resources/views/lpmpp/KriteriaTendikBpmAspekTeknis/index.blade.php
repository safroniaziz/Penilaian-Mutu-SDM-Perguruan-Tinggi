    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-calendar-times-o"></i>&nbsp;Kriteria Aspek Teknis</h3>
                <div class="pull-right">
                    <a href="{{ route('lpmpp.KriteriaTendikBpmAspekTeknis.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Kriteria Aspek Teknis</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                                    ...
                                    <td> {{ $kriteria->kriteria }} </td>
                                          <td style="display:inline-block !important;">
                                            <table>
                                                <tr>
                                                    <td>
                                                       <a href="{{ route('lpmpp.KriteriaTendikBpmAspekTeknis.edit',[$kriteria->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>


                                                    </td>
                                                    <td>

                                                       <form action="{{ route('lpmpp.KriteriaTendikBpmAspekTeknis.delete',[$kriteria->id]) }}" method="POST">
