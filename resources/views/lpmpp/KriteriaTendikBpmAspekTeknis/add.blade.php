    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-calendar-times-o"></i>&nbsp;Tambah Data Kriteria Aspek Teknis</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('lpmpp.KriteriaTendikBpmAspekTeknis.post') }}" enctype="multipart/form-data" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }} {{ method_field('POST') }}
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1">Nama Kriteria Aspek Teknis</label>
                            ...
                            <div class="col-md-12 text-center">
                                <a href="{{ route('lpmpp.KriteriaTendikBpmAspekTeknis') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
