        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <a href="{{ route('lpmpp.reviewers.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Reviewer</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                    ...
                    <table class="table table-striped table-bordered" id="table" style="width:100%;">
                        ...
                        <tbody>
                            ...
                            @foreach ($reviewers as $reviewer)
                                <tr>
                                    <td> {{ $no++ }} </td>
                                    <td> {{ $reviewer->nama_lengkap }} </td>
                                    <td> {{ $reviewer->nip }} </td>
                                    <td> {{ $reviewer->unit->nama_unit }} </td>
                                    <td style="display:inline-block !important;">
                                        <table>
                                            <tr>
                                                <td>

                                                    <form action="{{ route('lpmpp.reviewers.delete',[$reviewer->id]) }}" method="POST">
