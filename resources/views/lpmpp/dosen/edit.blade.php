        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('lpmpp.dosen.update',[$data->id]) }}" method="POST" >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-12 text-center">
                                <a href="{{ route('lpmpp.dosen') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
