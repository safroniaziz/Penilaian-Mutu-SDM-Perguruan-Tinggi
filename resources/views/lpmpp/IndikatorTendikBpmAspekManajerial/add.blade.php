    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-calendar-times-o"></i>&nbsp;Tambah Data Indikator Penilaian</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('lpmpp.IndikatorTendikBpmAspekManajerial.post') }}" enctype="multipart/form-data" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }} {{ method_field('POST') }}
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1">Pilih Kriteria</label>
                                <select name="kriteria_aspek_manajerial_id" class="form-control">
                            ...
                            @endforeach
                                ...
                                <div>
                                    @if ($errors->has('kriteria_aspek_manajerial_id'))
                                        <small class="form-text text-danger">{{ $errors->first('kriteria_aspek_manajerial_id') }}</small>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 text-center">
                                <a href="{{ route('lpmpp.IndikatorTendikBpmAspekManajerial') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
