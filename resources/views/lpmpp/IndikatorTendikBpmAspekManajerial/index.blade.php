        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <a href="{{ route('lpmpp.IndikatorTendikBpmAspekManajerial.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Indikator Penilaian</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <form action="{{ route('lpmpp.IndikatorTendikBpmAspekManajerial',[$indikator->id]) }}" method="POST">
