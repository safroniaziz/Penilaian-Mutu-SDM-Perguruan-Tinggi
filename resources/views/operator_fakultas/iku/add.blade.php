    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-user-circle"></i>&nbsp;Tambah Data IKU Pimpinan</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('operator_fakultas.iku.post') }}" method="POST" >
                        {{ csrf_field() }} {{ method_field('POST') }}
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1">Judul IKK</label>
                                <input type="text" name="judul_ikk" class="form-control" >
                                <div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="keterangan_ikk" class="form-control" id="" cols="30" rows="10"></textarea>
                                <div>
