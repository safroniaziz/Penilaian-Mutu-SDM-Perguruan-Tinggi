...
class CreateSkpKhususProfessorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('skp_khusus_professors', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('skp_khusus_professors');
    }
}
